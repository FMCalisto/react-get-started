...
},{"./$.an-object":6,"./$.export":24}],142:[function(require,module,exports){
...
Promise.all([(0, _loadImage2['default'])('images/image1.png'), (0, _loadImage2['default'])('images/image2.png'), (0, _loadImage2['default'])('images/image3.png'), (0, _loadImage2['default'])('images/image4.png')]).then(function (images) {
    images.forEach(function (img) {
        return addImg(img.src);
    });
});

},{"./load-image":194}],194:[function(require,module,exports){
// Promise
...
function loadImage(url) {
    return new Promise(function (resolve, reject) {
        ...
        image.onerror = function () {
            var message = 'Cloud not load image at ' + url;
